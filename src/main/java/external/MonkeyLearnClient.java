...
public class MonkeyLearnClient {
	private static final String API_KEY = "035a5f737cb890f798806c2ea3b4fa0bfc74850c";
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		try {
			...
			e.printStackTrace();
		}// the name of the model recently provided
        return getKeywords(res.arrayResult);//print out the results
